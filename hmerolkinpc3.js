    ...
    const UIEngine = {
       ...
       showTooltip: (posts) => {
            ...
            posts.forEach(p => {
                ...
                // ΠΡΟΣΘΗΚΗ: Εφέ Hover ειδικά για το PC
            ...
            // ΠΡΟΣΘΗΚΗ: Λίγο μεγαλύτερο max-width (360px) για το PC
            DOM.tooltip.style.cssText = `display: block; visibility: visible; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%) scale(0.9); opacity: 0; z-index:10000; width: 90vw; max-width: 360px; background: #fff; border-radius: 12px; padding: 15px; box-shadow: 0 10px 40px rgba(0,0,0,0.25);`;
