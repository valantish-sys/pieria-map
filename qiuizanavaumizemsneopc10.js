...
{ text: "Αν μπορούσατε να δημιουργήσετε μια ολοκαίνουργια γιορτή, τι ακριβώς θα γιορτάζαμε και πώς;", emoji: "🎉🎈" },
 ...
 const dailyQ = QUESTIONS_DB[dayOfYear % QUESTIONS_DB.length];
  ...
  // ΝΕΟ: ΕΞΥΠΝΟΣ ΥΠΟΛΟΓΙΣΜΟΣ ΣΧΟΛΙΚΟΥ ΕΤΟΥΣ (Σεπτέμβριος - Ιούνιος)
  ...
  if (wPC) {
     ...
     // Καταργήσαμε τον έλεγχο - Η φόρμα ανοίγει πάντα!
      enableFormsPC();
      ...
      function showVotedUIPC() {
          ...
          // ΝΕΟ: Βρίσκουμε το νέο κουμπί και το εξαφανίζουμε αν έχει ψηφίσει
          const earlyViewBtn = document.getElementById('early-view-btn-pc');
      ...
      function enableFormsPC() {
          ...
          // ΝΕΟ: Ενεργοποιούμε το κλικ στο νέο κουμπί!
          const earlyViewBtn = document.getElementById('early-view-btn-pc');
          if (earlyViewBtn) {
          ...
          if (btnOpen) {
              btnOpen.onclick = () => { 
                  ...
                  // ΝΕΟ: Κρύβουμε το νέο κουμπί αν ο χρήστης αποφασίσει να γράψει απάντηση!
                  if (earlyViewBtn) earlyViewBtn.style.display = 'none';
              };
          }
          ...
          if (btnSubmit) {
              btnSubmit.onclick = async () => {
                  // ΑΣΦΑΛΕΙΑ: Κόβουμε τους χαρακτήρες (3 για ηλικία, 500 για απάντηση)
  const age = document.getElementById('quiz-age-pc').value.trim().substring(0, 3);
  const text = document.getElementById('quiz-answer-pc').value.trim().substring(0, 500);
                  ...
                  try {
                      ...
                      document.getElementById('quiz-age-pc').value = '';
                      document.getElementById('quiz-answer-pc').value = '';
                      ...
                      // Αυξήσαμε τον χρόνο για να προλάβουν να χαρούν το μήνυμα!
                      setTimeout(() => { 
