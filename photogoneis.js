...
window.openAlbumLightbox = function(index) {
    ...
    if (!lb) {
        ...
        lb.innerHTML = `
           ...
           <div class="lightbox-arrow1" style="position: absolute; left: 10px; color: white; font-size: 50px; cursor: pointer; padding: 20px; z-index: 10; user-select: none; text-shadow: 0 2px 5px rgba(0,0,0,0.5);" onclick="changeLightboxImage(-1, event)">&#10094;</div>
            ...
            <div class="lightbox-arrow1" style="position: absolute; right: 10px; color: white; font-size: 50px; cursor: pointer; padding: 20px; z-index: 10; user-select: none; text-shadow: 0 2px 5px rgba(0,0,0,0.5);" onclick="changeLightboxImage(1, event)">&#10095;</div>
        `;
