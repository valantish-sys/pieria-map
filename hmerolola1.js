(() => {
   ...
   const CONFIG = Object.freeze({
    ...
    const UIEngine = {
        ...
        init: () => {
            if (document.getElementById('calendar-overlay-unified')) return;
            
            UIEngine.overlay = document.createElement('div');
           UIEngine.overlay.id = 'calendar-overlay'; // Κρατάμε το αυθεντικό ID του PC
        ...
        const self = {
            ...
            init: () => {
               ...
               self.els.yearOverlay = document.createElement('div');
                ...
                self.els.yearOverlay.className = 'year-view-overlay'; // Προσθήκη για να πιάσει το CSS!
