...
// --- 1. ΟΜΑΛΗ ΜΕΤΑΒΑΣΗ (FADE IN/OUT) - BULLETPROOF ---
   ...
   setupSensors: () => {
      ...
      if (window.matchMedia("(hover: hover)").matches) {
       ...
       // ΚΛΕΙΔΩΜΑ JITTER: Αφαιρούμε προσωρινά το CSS transform για να διαβάσουμε 
         // τις 100% καθαρές συντεταγμένες της βάσης, χωρίς την παρεμβολή του animation!
...
// Η συνάρτηση που κάνει την πραγματική σύνδεση
    ...
    let isVerticalScrolling = false; 
     ...
     const handleDragStart = (e) => {
        ...
        container.dataset.hasMoved = 'false'; // ΝΕΟ: Επαναφορά κίνησης σε κάθε νέο άγγιγμα
