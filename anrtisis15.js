...
// ΝΕΟ: Εξαγωγή μόνο των συναρτήσεων που χρειάζεται να "βλέπει" η HTML
window.previewParentImage = previewParentImage;
window.submitParentPost = submitParentPost;

})(); // <-- Εδώ κλείνει το IIFE (το προστατευμένο κουτί μας)
