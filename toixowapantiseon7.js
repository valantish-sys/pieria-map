         ...
         // Ελέγχουμε αν ο χρήστης έχει ενεργή αναζήτηση τη στιγμή της ενημέρωσης
          ...
          if (window.activeQuestionId && document.getElementById('view-answers').style.display === 'block') {
             ...
             if (activeGroup) {
                 ...
                 // Αποτροπή άσκοπης ανανέωσης αν ο αριθμός των εγκεκριμένων απαντήσεων δεν άλλαξε
                 if (ansContainer.children.length === activeGroup.answers.length) return;
...
window.goBack = () => {
      ...
      // (Bug 3) Επαναφορά του χρήστη στην ακριβή θέση κύλισης που βρισκόταν!
