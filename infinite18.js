const initInfiniteScroll = () => {
    ...
    // ΝΕΑ ΔΙΟΡΘΩΣΗ: Κλείδωμα αποτροπής διπλής εκτέλεσης. Εμποδίζει 
    // τη δημιουργία διπλότυπων αναρτήσεων αν η λειτουργία κληθεί ξανά.
            ...
            if (postsArray.length > 0) {
                ...
                postsArray.forEach(post => {
                 ...
                 // ΝΕΑ ΔΙΟΡΘΩΣΗ: Επειδή το Lightbox του Blogger αγνοεί τις νέες εικόνες, 
                    ...
                    // η θέση scrolling όταν ο γονιός πατήσει το κουμπί "Πίσω".
                    // ΠΡΟΣΤΑΣΙΑ: Επεκτείνεται υποχρεωτικά στους τίτλους των νέων άρθρων και τα "Read more".
                    post.querySelectorAll('a[imageanchor="1"], a[href$=".jpg"], a[href$=".png"], a[href$=".jpeg"], .post-title a, h3 a, .jump-link a, a.more-link').forEach(link => {
