 ...
 const dailyQ = QUESTIONS_DB[dayOfYear % QUESTIONS_DB.length];
  ...
  const text = document.getElementById('quiz-answer-pc').value.trim().substring(0, 500);
                  ...
                  try {
                      ...
                      // ΔΕΝ κλειδώνουμε πλέον την ψήφο στο localStorage!
                      
                      // Καθαρίζουμε τα πεδία για να γράψουν νέα απάντηση αν θέλουν
                      ...
                      // Μετά από 2.5 δευτερόλεπτα, κρύβουμε το μήνυμα και επαναφέρουμε το κουμπί
                      setTimeout(() => { 
