  ...
  const Utils = {
    ...
    // ==========================================
        ...
        getLandmarkIcon: (date) => {
            ...
            // Αν θέλεις π.χ. πινέζα για όλα, άλλαξε το '🇬🇷' σε '📌'
            if (m === 3 && d === 25) return { icon: '🇬🇷', name: '25η Μαρτίου' };
            if (m === 5 && d === 1) return { icon: '🌸', name: 'Εργατική Πρωτομαγιά' };
            if (m === 10 && d === 28) return { icon: '🇬🇷', name: '28η Οκτωβρίου' };
            if (m === 11 && d === 17) return { icon: '🕊️', name: '17η Νοεμβρίου' };
            if (m === 12 && d === 18) return { icon: '🐾', name: 'Άγιος Μόδεστος' };
            if (m === 12 && d === 25) return { icon: '🎄', name: 'Χριστούγεννα' };
            ...
            if (daysDiff === -48) return { icon: '🪁', name: 'Καθαρά Δευτέρα' };
            if (daysDiff === 0) return { icon: '🕯️', name: 'Κυριακή του Πάσχα' };
            if (daysDiff === 50) return { icon: '🌿', name: 'Αγίου Πνεύματος' };
