   ...
   const CONFIG = Object.freeze({
    ...
    const UIEngine = {
        ...
        init: () => {
            ...
            UIEngine.overlay.id = 'calendar-overlay-unified';
            ...
            UIEngine.tooltip.id = 'calendar-tooltip-unified';
                ...
                const spinInterval = setInterval(() => {
                    ...
                    if (spins >= maxSpins) {
                        ...
                        setTimeout(() => {
                            ...
                            if (cell) UIEngine.showTooltip(cell, DataEngine.postsByDate[targetDateStr], true, isPC);
                        }, 400); 
                    }
                }, 120);
            },
