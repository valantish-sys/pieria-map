        ...
        fetchPosts: async () => {
            ...
            try {
               ...
               const totalPosts = parseInt(metaData.feed.openSearch$totalResults.$t, 10);
                ...
                // Περιορισμός του index στο μέγιστο όριο (500) για αποφυγή κατάρρευσης του API
                const maxPosts = Math.min(totalPosts, 500); 
                const randomIndex = Math.floor(Math.random() * maxPosts) + 1;
