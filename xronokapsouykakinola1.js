      ...
      isFetching: false,
        fetchPosts: async () => {
            ...
            try {
                ...
                DOM.titles.forEach(t => t.innerText = "Σφάλμα Φόρτωσης");
                DOM.descs.forEach(d => d.innerText = "Δεν μπορέσαμε να ανακτήσουμε τη μνήμη.");
            } finally {
        ...
        init: () => {
            DOM.widgets.forEach(widget => {
                ...
                widget.addEventListener('touchend', (e) => {
                    ...
                    const deltaX = SwipeEngine.startX - endX;
            ...
            window.addEventListener('mouseup', (e) => {
                ...
                const deltaX = SwipeEngine.startX - e.pageX;
