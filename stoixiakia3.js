...
/* --- ΕΞΥΠΝΟΣ ΧΑΙΡΕΤΙΣΜΟΣ --- */
  ...
  /* ========================================================================
     ...
     ======================================================================== */
  const init3DTilt = () => {
    // 🛑 ΣΗΜΑΝΤΙΚΟ: Το απενεργοποιούμε στα κινητά (εκεί δεν υπάρχει hover).
    // Έτσι γλιτώνουμε μπαταρία και αποτρέπουμε bugs.
    ...
    cards.forEach(card => {
      ...
      card.addEventListener('mouseenter', () => {
        // Αφαιρούμε το CSS transition για να υπακούει ακαριαία στο χέρι μας (0 lag)
