              ...
              <div class="date-posts">
                <div class="post-outer">
                 ...
                 <div class="post-body entry-content" style="margin-top: 15px; font-size: 110%; line-height: 1.5;">
                      ${imgHtml}
                      ${(function() {
                          let safeContent = escapeHTML(fbPost.content);
                          if (safeContent.includes('[READ_MORE]')) {
                              ...
                              return `
                                  ...
                                  <div id="more-text-${fbPost.id}" style="display:none; white-space: pre-wrap; margin-top: 15px; padding-top: 15px; border-top: 1px dashed #ddd;">${secondPart}</div>
                                  <button onclick="document.getElementById('more-text-${fbPost.id}').style.display='block'; this.style.display='none';" 
                                          style="background: rgba(30,108,255,0.1); color: #1e6cff; border: none; font-weight: bold; cursor: pointer; padding: 6px 15px; margin-top: 10px; border-radius: 20px; font-size: 14px; transition: background 0.3s;">
                                      Διαβάστε περισσότερα 👇
                                  </button>
                              `;
                          }
                          return `<p style="white-space: pre-wrap; margin:0;">${safeContent}</p>`;
                      })()}
