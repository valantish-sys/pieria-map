    ...
    modalBox.addEventListener('touchmove', (e) => {
      ...
      let target = e.target;
       ...
       if (diffY > 0) {
          ...
          // Επαναφορά στην αρχική θέση αν ο χρήστης αναιρέσει την κίνηση προς τα κάτω
...
/* --- ΕΞΥΠΝΟΣ ΧΑΙΡΕΤΙΣΜΟΣ --- */
  ...
  card.addEventListener('pointerleave', (e) => {
        // Διαγραφή του περιορισμού αφής ώστε η κάρτα να κάνει reset σωστά σε υβριδικά Laptops
  ...
  const initButtonFX = () => {
    ...
    modalButtons.forEach(btn => {
     ...
     if (!isTouchDevice) {
      let btnRect, absCenterX, absCenterY;
