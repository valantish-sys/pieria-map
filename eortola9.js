...
const diffFromEaster = Utils.getDaysDiff(dDate, realEaster);
         ...
         // Εναλλαγή προγράμματος ανάλογα με το αν η μέρα του μήνα είναι ζυγή ή μονή
            ...
            if (isHoliday) { // Εθνικές Εορτές & Αργίες
                if (isEven) {
                    return `${wStart}
                            <span class="sch-time">🎈 10:30 Άραγμα</span>
                            <span class="sch-time">🎉 12:30 Γιορτή</span>
                            <span class="sch-time">🍖 15:00 Τραπέζι</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">🏃 18:00 Βόλτα</span>
                            ${wEnd}`;
                } else {
                    return `${wStart}
                            <span class="sch-time">🇬🇷 11:00 Παρέλαση</span>
                            <span class="sch-time">🚶 13:00 Περίπατος</span>
                            <span class="sch-time">🍰 16:00 Γλυκό</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">💤 19:00 Σπίτι</span>
                            ${wEnd}`;
                }
            }
            if (diffFromEaster >= -8 && diffFromEaster <= 7) { // Διακοπές Πάσχα
                if (isEven) {
                    return `${wStart}
                            <span class="sch-time">🥚 10:00 Αυγά</span>
                            <span class="sch-time">🍖 13:30 Ψήσιμο</span>
                            <span class="sch-time">🍬 16:00 Γλυκά</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">🧨 20:00 Πλατεία</span>
                            ${wEnd}`;
                } else {
                    return `${wStart}
                            <span class="sch-time">🌼 11:00 Εξοχή</span>
            ...
            if ((m === 12 && d >= 24) || (m === 1 && d <= 7)) { // Διακοπές Χριστουγέννων
                if (isEven) {
                    return `${wStart}
                            <span class="sch-time">🛏️ 10:00 Πιτζάμες</span>
                    ...
                    return `${wStart}
                            <span class="sch-time">☕ 10:30 Καφές</span>
                            <span class="sch-time">🎁 13:00 Δώρα</span>
                            <span class="sch-time">🎲 16:30 Παιχνίδι</span>
            ...
            if ((m === 6 && d >= 16) || m === 7 || m === 8 || (m === 9 && d <= 10)) { // Καλοκαιρινές Διακοπές
                if (isEven) {
                    return `${wStart}
                            <span class="sch-time">🏖️ 10:00 Μπάνιο</span>
                    ...
                    return `${wStart}
                            <span class="sch-time">🕶️ 11:00 Ήλιος</span>
                            <span class="sch-time">🌊 15:00 Βουτιές</span>
            ...
            if (dayOfWeek === 0 || dayOfWeek === 6) { // Απλό Σαββατοκύριακο
                if (isEven) {
                    return `${wStart}
                            <span class="sch-time">📺 10:00 Παιδικά</span>
                    ...
                    return `${wStart}
                            <span class="sch-time">🥞 10:30 Πρωινό</span>
