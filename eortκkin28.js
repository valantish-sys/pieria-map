                    ...
                    if (i === 0) {
                     ...
                     // --- ΝΕΟ: ΕΞΥΠΝΟΣ ΣΥΜΒΟΥΛΟΣ (Μπήκε ΜΕΣΑ στο if (i === 0) !) ---
                        ...
                        if (advisorBox) {
                            ...
                            // Κρύβεται ΜΟΝΟ αν είναι πριν τις 7 το πρωί Ή από τις 4 το απόγευμα (16:00) και μετά
                            if (hourNow < 7 || hourNow >= 16) {
                                advisorBox.style.display = 'none';
                            } else {
                                // Έλεγχος για βροχή/χιόνι από την ΤΡΕΧΟΥΣΑ ώρα έως τις 14:00 (2 το μεσημέρι)
                                // Έτσι, αν η ώρα είναι π.χ. 11:00, η βροχή των 10:00 αγνοείται εντελώς!
                                let hasRain = false, hasSnow = false;
                                const checkUntil = hourNow <= 14 ? 14 : hourNow;
                                
                                for (let h = hourNow; h <= checkUntil; h++) {
                                ...
                                const currentTemp = data.hourly.apparent_temperature[baseIndex + hourNow];
