  ...
  const DataEngine = {
    ...
    const MobileUIEngine = {
        renderHeader: () => {
           ...
           if (mIcon) {
                // Επαναφέρει το εικονίδιο στο κλασικό του αν δεν είναι Καθαρά Δευτέρα
                // (Αν αντί για 📅 έχεις βάλει κάτι άλλο στο HTML σου, βάλε εκείνο)
                mIcon.innerText = (MobileDateEngine.diffFromEaster === -48) ? "🪁" : "📅"; 
            }
        },
        renderHolidays: () => {
