(() => {
    ...
    const MobileHolidayEngine = {
        getWorldDays: () => {
            let days = [];
            if (CONFIG.dictionaries.worldDays[MobileDateEngine.dateKey]) days.push(CONFIG.dictionaries.worldDays[MobileDateEngine.dateKey]);
        ...
        getHolidays: () => {
            ...
            if (CONFIG.dictionaries.fixedHolidays[MobileDateEngine.dateKey]) {
                holidays.push(CONFIG.dictionaries.fixedHolidays[MobileDateEngine.dateKey]);
            }
            return holidays;
        },
        getNames: () => {
            ...
            return CONFIG.dictionaries.fixedNames[MobileDateEngine.dateKey] || "";
        },
        getSchoolHolidays: () => {
