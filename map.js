...
mythic_typhon: { 
  ...
  eco_turtle: { 
    ...
    desc: "Η αρχόντισσα της άμμου! Οι ακτές της Πιερίας είναι γνωστά περάσματα για τις θαλάσσιες χελώνες που αναζητούν ασφαλείς αμμουδιές.", 
  ...
  sea_delfini: { 
    title: "Ρινοδέλφινο 🐬", 
    desc: "Ο πιστός μας σύντροφος. Τα δελφίνια συχνά ακολουθούν τις ψαρόβαρκες στα ανοιχτά του Λιτοχώρου και της Παραλίας Κατερίνης.", 
