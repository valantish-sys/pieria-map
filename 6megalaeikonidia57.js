...
const activeLang = document.querySelector('select.goog-te-combo')?.value;
  ...
  // ΠΡΟΣΘΗΚΗ: Έλεγχος αν υπάρχουν πολλαπλά άρθρα, αποτρέποντας την ανάγνωση λάθος κειμένου
  const articles = document.querySelectorAll('.post-body, .entry-content, article');
