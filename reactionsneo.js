...
class FeedbackEngine {
            ...
            static handleReaction(btn) {
                ...
                // 2Η ΑΛΛΑΓΗ: Ασφαλής καταγραφή ψήφου με Firebase Transaction
                ...
                runTransaction(reactionRef, (currentCount) => {
                    ...
                    // Το νούμερο ΔΕΝ χρειάζεται να το ενημερώσουμε χειροκίνητα. 
                    // Θα ενημερωθεί μόνο του σε ms χάρη στο onValue() της scan!
                }).catch(() => {
