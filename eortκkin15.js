  ...
  const DataEngine = {
    ...
    const MobileHolidayEngine = {
        ...
        getNames: () => {
            ...
            if (diff === 2) return "Ραφαήλ, Νικόλαος, Ειρήνη (Λέσβου)" + (DateEngine.diffFromEaster <= 1 ? ", Μάρκος" : "");
          ...
          if (DateEngine.dateKey === "4-25") return DateEngine.diffFromEaster <= 1 ? "Νίκη" : "Μάρκος, Νίκη"; // Η Νίκη μένει σταθερή.
