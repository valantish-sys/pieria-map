document.addEventListener("DOMContentLoaded", () => {
  ...
  const tickerContainer = document.getElementById(config.containerId);
   ...
   try {
    ...
    // ΛΥΣΗ BUG 1: Σεβόμαστε το config.maxPosts αν είναι μεγαλύτερο, 
      // αλλά κρατάμε το ελάχιστο όριο στα 6 στοιχεία για να μην υπάρχουν "τρύπες" στην οθόνη.
      const targetCount = Math.max(6, config.maxPosts);
   ...
   // ΛΥΣΗ BUG 3: Περιμένουμε τις γραμματοσειρές με όριο (Timeout) 600ms. 
      ...
      // ΛΥΣΗ BUG 4 & BUG 5 (Με τη δική σου προσθήκη Σταθερής Ταχύτητας)
      let lastWidth = -1;
      ...
      // ΛΥΣΗ BUG 5: Υπολογισμός με ακρίβεια δεκαδικών ψηφίων (sub-pixels) 
        // ώστε το Loop να είναι 100% ομαλό χωρίς το παραμικρό "πήδημα" (λόξιγκα).
      ...
      // Ο Observer αναλαμβάνει να το τρέξει (Λύνει το Mobile Rotation - Bug 4)
