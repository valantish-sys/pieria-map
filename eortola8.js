...
const diffFromEaster = Utils.getDaysDiff(dDate, realEaster);
           ...
           // Εναλλαγή προγράμματος ανάλογα με το αν η μέρα του μήνα είναι ζυγή ή μονή
            ...
            if (isHoliday) { // Εθνικές Εορτές & Αργίες
                if (isEven) {
                    return `<span class="sch-time">🎈 10:30 Ξύπνημα</span>
                            <span class="sch-time">🎉 12:30 Γιορτή</span>
                            <span class="sch-time">🍖 15:00 Τραπέζι</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">🏃 18:00 Πλατεία</span>`;
                } else {
                    return `<span class="sch-time">🇬🇷 11:00 Παρέλαση</span>
                            <span class="sch-time">🚶 13:00 Περίπατος</span>
                            <span class="sch-time">🍰 16:00 Γλυκό</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">💤 19:00 Χαλάρωση</span>`;
                }
            }
            if (diffFromEaster >= -8 && diffFromEaster <= 7) { // Διακοπές Πάσχα
                if (isEven) {
                    return `<span class="sch-time">🥚 10:00 Τσούγκρισμα</span>
                            <span class="sch-time">🍖 13:30 Ψήσιμο</span>
                            <span class="sch-time">🍬 16:00 Κεράσματα</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">🧨 20:00 Βεγγαλικά</span>`;
                } else {
                    return `<span class="sch-time">🌼 11:00 Εξοχή</span>
                            <span class="sch-time">🪁 14:00 Παιχνίδι</span>
                            <span class="sch-time">🍰 17:00 Τσουρέκι</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">🚲 19:30 Βόλτα</span>`;
                }
            }
            if ((m === 12 && d >= 24) || (m === 1 && d <= 7)) { // Διακοπές Χριστουγέννων
                if (isEven) {
                    return `<span class="sch-time">🛏️ 10:00 Πιτζάμες</span>
                            <span class="sch-time">🎄 12:30 Κάλαντα</span>
                            <span class="sch-time">🍪 15:00 Γλυκά!</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">🎬 19:00 Ταινία</span>`;
                } else {
                    return `<span class="sch-time">☕ 10:30 Σοκολάτα</span>
                            <span class="sch-time">🎁 13:00 Δώρα</span>
                            <span class="sch-time">🎲 16:30 Επιτραπέζια</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">🛌 21:00 Ύπνος</span>`;
                }
            }
            if ((m === 6 && d >= 16) || m === 7 || m === 8 || (m === 9 && d <= 10)) { // Καλοκαιρινές Διακοπές
                if (isEven) {
                    return `<span class="sch-time">🏖️ 10:00 Μπάνιο</span>
                            <span class="sch-time">🍉 14:00 Καρπούζι</span>
                            <span class="sch-time">🚲 18:30 Ποδήλατο</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">🍦 21:00 Παγωτό</span>`;
                } else {
                    return `<span class="sch-time">🕶️ 11:00 Ήλιος</span>
                            <span class="sch-time">🌊 15:00 Νεροπόλεμος</span>
                            <span class="sch-time">⚽ 19:00 Πλατεία</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">🥤 21:30 Βόλτα</span>`;
                }
            }
            if (dayOfWeek === 0 || dayOfWeek === 6) { // Απλό Σαββατοκύριακο
                if (isEven) {
                    return `<span class="sch-time">📺 10:00 Παιδικά</span>
                            <span class="sch-time">⚽ 12:30 Παιχνίδι</span>
                            <span class="sch-time">🍝 14:30 Φαγητό</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">💤 16:00 Χουζούρι</span>`;
                } else {
                    return `<span class="sch-time">🥞 10:30 Πρωινό</span>
                            <span class="sch-time">🚲 13:00 Βόλτα</span>
                            <span class="sch-time">🎮 16:30 Gaming</span>
                            <span class="sch-time" style="color:#a90e0e; margin-top:3px;">🍿 20:00 Σινεμά</span>`;
                }
            }
