          ...
          playRoulette: () => {
           ...
           let touchstartX = 0, startY = 0, isSwiping = false, swipeTimeout = null; 
              ...
              self.els.container.addEventListener('touchend', (e) => {
                    ...
                    // ✅ ΔΙΟΡΘΩΣΗ: Αφαιρέσαμε το "|| self.isYearView" που σταματούσε την κίνηση.
                    // Τώρα το swipe σταματάει ΜΟΝΟ αν γυρνάει η ρουλέτα, παίζει animation ή είναι ανοιχτό popup.
