        ...
        init: async () => { // <--- Έγινε async
          ...
          // --- ΝΕΟ: ANIMATED ΑΛΛΑΓΗ ΗΜΕΡΑΣ (PC) ---
            const animateAndChangeDay = (offset) => {
                // Χρησιμοποιούμε το eortBox για να στοχεύσουμε ΜΟΝΟ τα στοιχεία του PC widget, 
                // ώστε να μην επηρεάζεται το Mobile widget (αν είναι στην ίδια σελίδα).
            ...
            // Αφή (Swipe) για PC (για laptops με touch screen ή tablets)
            let touchStartX = 0;
            if (eortBox) {
