...
import { getDatabase, ref, push, set } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-database.js";
 ...
 // ΕΞΥΠΝΗ ΣΥΝΔΕΣΗ: Αν υπάρχει ήδη ανοιχτό Firebase στη σελίδα το παίρνει, αλλιώς το ανοίγει!
  const appPC = !getApps().length ? initializeApp(firebaseConfig) : getApp();
...
{ text: "Αν μπορούσατε να δημιουργήσετε μια ολοκαίνουργια γιορτή, τι ακριβώς θα γιορτάζαμε και πώς;", emoji: "🎉🎈" },
  ...
  // Προσθέτουμε το έτος για να είναι μοναδικό κάθε χρονιά!
  const dayKey = `year_${today.getFullYear()}_day_${dayOfYear}`;
