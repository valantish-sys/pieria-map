...
db.ref().update(updates).then(() => {
    // Ο καθαρισμός γίνεται ΜΟΝΟ ΑΦΟΥ επιβεβαιωθεί η εγγραφή από τη βάση
    ...
    showToast("Σφάλμα σύνδεσης. Οι επιλογές σας διατηρήθηκαν.", true);
  });
}
...
function setActiveTheme(id) {
  // Ανάκτηση του καθαρού ονόματος απευθείας από τη μνήμη
  const cleanName = allThemes[id] ? allThemes[id].name : "";
