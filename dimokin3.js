...
{ title: "Προστατεύομαι από τους σεισμούς", link: "https://dimperist.blogspot.com/p/blog-page_59.html", image: "" },
  ...
  const ApiManager = {
    fetchData: async () => {
     try {
        // ΝΕΟ: Αν το ένα feed αποτύχει, επιστρέφει null και ΔΕΝ καταστρέφει το άλλο!
       ...
       // ΝΕΟ: Άμεσα το 1ο slide, τα υπόλοιπα φορτώνουν μόνο όταν πλησιάζει να τα δει ο χρήστης!
