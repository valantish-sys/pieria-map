  ...
  platforms.forEach(platform => {
      ...
      if (w) {
          ...
          function enableForms() {
             ...
             if (btnSubmit) {
                  // Προσθέτουμε το (e) (δηλαδή το event) ως παράμετρο
                  btnSubmit.onclick = async (e) => {
                      // ΛΥΣΗ: Αποτρέπουμε την ανανέωση της σελίδας που ακυρώνει την αποστολή στο Firebase!
                      if (e) e.preventDefault();

                      // 1. Δόνηση ΜΟΝΟ για συσκευές αφής (κινητά), στο PC απλά το αγνοεί!
                      ...
                      try {
                          // 3. Στέλνουμε τα δεδομένα στη βάση (χρησιμοποιώντας το κοινό 'db' της 1ης Αλλαγής)
