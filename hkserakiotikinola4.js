(() => {
  ...
  if (window.location.pathname === '/' || window.location.pathname === '/index.html') {
    ...
    // ΔΙΟΡΘΩΣΗ: Πλέον κρύβει το Desktop ΜΟΝΟ έως τα 767px (για να συμφωνεί απόλυτα με το CSS)
    hideStyle.innerHTML = `
  ...
  const Utils = {
    ...
    // Το decodeHTML αφαιρέθηκε καθώς το innerHTML το καθιστά περιττό.
  };
  ...
  const FlipManager = {
    ...
    buildWidget: (suffix) => {
      ...
      const updateDOM = () => {
        ...
        if (nextFact) {
          // ΔΙΟΡΘΩΣΗ: Πλέον και το PC και το Κινητό λειτουργούν το ίδιο αξιόπιστα!
