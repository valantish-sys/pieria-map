                ...
                this.observer = new IntersectionObserver((entries, obs) => {
                    ...
                    get(ref(db, 'reactions/' + safePostId)).then((snapshot) => {
                           const d = snapshot.val() || { love: 0, funny: 0, wow: 0 };
                                // ΣΥΓΧΡΟΝΙΣΜΟΣ ΔΕΔΟΜΕΝΩΝ: Ενημερώνουμε ΜΟΝΟ όσα Emojis δεν έχουν λάβει ακόμα δεδομένα (δείχνουν "-").
                                // Έτσι ΔΕΝ ακυρώνουμε όλο το Lazy Load αν ο χρήστης ψηφίσει ένα συγκεκριμένο emoji πριν προλάβουν να φορτώσουν!
