...
// Αποτροπή κανονικής πλοήγησης στο κλικ (και εκτέλεση του δικού μας script)
    ...
    const loadNextPage = async () => {
        ...
        try {
           ...
           // Parsing στο background
            ...
            const newPosts = newDocContainer ? newDocContainer.querySelectorAll('.date-outer, .post-outer, article.post') : [];
            ...
            if (newPosts.length > 0) {
                ...
                // Διαφορετικά, αν το container είναι το #main, θα έμπαιναν ΚΑΤΩ από το κουμπί φόρτωσης / footer!
                const currentPosts = postsContainer.querySelectorAll('.date-outer, .post-outer, article.post');
            ...
            // ΔΙΟΡΘΩΣΗ: Ανοίγουμε τον observer ξανά ΜΟΝΟ αν πέτυχε το fetch (αποτροπή άπειρης λούπας).
            // Σε περίπτωση σφάλματος, ο observer μένει κλειστός και ο χρήστης πατάει το κουμπί χειροκίνητα.
