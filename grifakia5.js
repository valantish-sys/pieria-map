(() => {
  ...
  const RiddleManager = {
    init: () => {
      // Το DOM διαβάζεται ΑΦΟΥ φορτώσει το HTML
      DOM.box = document.getElementById("daily-riddle-box");
      DOM.question = document.getElementById("daily-riddle-question");
      DOM.answer = document.getElementById("daily-riddle-answer");
