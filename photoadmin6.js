...
if (photo.status === "pending") {
  ...
  if (existingCard) {
      existingCard.draggable = !editMode[photo.key]; // Απενεργοποίηση drag κατά την επεξεργασία κειμένου
      if (existingCard.dataset.content !== innerHtml) {
       ...
       if (currentEditText !== null) {
            ...
            if (newEditInput) {
                ...
                if (isFocused) {
                    newEditInput.focus();
                    if (caretStart !== null) newEditInput.setSelectionRange(caretStart, caretEnd);
                }
            }
        }
      }
