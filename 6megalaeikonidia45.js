...
const speech = new SpeechSynthesisUtterance();
  ...
  // ΔΙΟΡΘΩΣΗ: Καταργήθηκε το document.body για να αποφευχθεί η χαοτική ανάγνωση άσχετων στοιχείων (το fallbackElement μπορεί πλέον να είναι null)
  const fallbackElement = document.querySelector('.main-wrapper');
const textToRead = article ? article.innerText : (fallbackElement ? fallbackElement.innerText : '');
...
if (lang === 'el') {
    ...
    // 2. Επαναφορά ΑΠΟΚΟΠΤΟΝΤΑΣ βίαια το μολυσμένο hash (π.χ. #googtrans) που προκαλεί τη λούπα!
