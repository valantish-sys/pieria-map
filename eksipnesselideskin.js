(() => {
    ...
    const DOM = {
        hub: document.getElementById("smart-hub-mobile"),
        content: document.getElementById("hub-content-mobile"),
        toggle: document.getElementById("hub-toggle-mobile"),
        dynamicContainer: document.getElementById("dynamic-posts-container-mobile")
    };
    ...
    const MobileApp = {
        init: () => {
            if (!DOM.hub) return;
            window.toggleSmartHubMobile = MobileUIManager.toggleMenu; // Εξαγωγή του mobile function
