...
async function loadSchoolYearActions(label, containerId) {
   ...
   // Κάνουμε "κύκλους" ζητώντας 50-50 μέχρι να μαζέψουμε ΟΛΑ τα άρθρα
     ...
     let assignedCategory = "📌 Γενικά"; 
        ...
        // ΚΑΘΑΡΙΣΜΟΣ HTML: Αφαίρεση ετικετών (tags), του &nbsp; και μετατροπή 
        // πολλαπλών κενών/αλλαγών γραμμής σε ένα μονό κενό διάστημα.
        ...
        const normalizedContent = normalizeText(cleanContent); // Πλέον διαβάζει μόνο το καθαρό κείμενο
