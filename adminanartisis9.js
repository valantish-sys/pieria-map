  ...
  let imgHtml = '';
      ...
      html += `
        <div class="post-card-admin" style="border-left: 5px solid ${borderColors[type]}; position: relative;">
          <!-- Κουμπί Εκτύπωσης -->
          <button onclick="window.printSinglePost('${p.id}')" style="position: absolute; top: 15px; right: 15px; background: none; border: none; cursor: pointer; font-size: 20px; z-index: 10;" title="Εκτύπωση / Αποθήκευση PDF">🖨️</button>
