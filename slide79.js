...
// 1. Έξυπνη αναγνώριση συσκευής (Λύνει το πρόβλημα των υβριδικών Laptops)
...
SM.container.addEventListener('touchstart', e => {
  ...
  SM.container.addEventListener('touchend', e => {
        // Διαγράφηκε ο περιορισμός "if (e.target.closest('.widget-overlay')) return;" για να λειτουργεί ελεύθερα το swipe
