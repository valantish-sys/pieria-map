                    ...
                    if (i === 0) {
                        ...
                        if (widgetBox) {
                           ...
                           const now = new Date();
                            ...
                            const currentMonth = now.getMonth(); // 0 = Ιανουάριος, 11 = Δεκέμβριος
                            
                            // Έξυπνος υπολογισμός δύσης ηλίου (Night Mode) για την Ελλάδα ανά μήνα
                            let sunsetHour = 20; 
                            if ([10, 11, 0, 1].includes(currentMonth)) sunsetHour = 18; // Νοέ-Φεβ (Χειμώνας)
                            else if ([2, 9].includes(currentMonth)) sunsetHour = 19; // Μάρτιος, Οκτώβριος
                            else if ([3, 8].includes(currentMonth)) sunsetHour = 20; // Απρίλιος, Σεπτέμβριος
                            else if ([4, 5, 6, 7].includes(currentMonth)) sunsetHour = 21; // Μάιος-Αύγουστος (Καλοκαίρι)
                    ...
                    // --- ΝΕΟ: ΕΞΥΠΝΟΣ ΣΥΜΒΟΥΛΟΣ (Μπήκε ΜΕΣΑ στο if (i === 0) !) ---
                        ...
                        if (advisorBox) {
                            ...
                            // 3. ΛΕΙΤΟΥΡΓΙΑ "ΑΥΡΙΟ" (16:00 το απόγευμα έως 01:59 το βράδυ)
                                    ...
                                    // ΛΥΣΗ: Δυναμικό λεκτικό. Αν έχει περάσει τα μεσάνυχτα, λέει "Το πρωί" αντί για "Αύριο"
                                   ...
                                   for (let h = 6; h <= 14; h++) {
                                    ...
                                    if (hasSnow) {
                                        ...
                                        icon = "🧣"; msg = `${textDay === "Το πρωί" ? "Σήμερα" : "Αύριο"} το πρωί θα έχει παγωνιά! Ετοίμασε σκούφο και γάντια!`; 
                                        borderColor = "#0ea5e9"; bgColor = "rgba(14, 165, 233, 0.1)";
                                    } else if (checkTemp > 21) {
            ...
            if (searchIcon && searchInput && searchResults) {
               searchIcon.addEventListener('click', (e) => {
                    ...
                    if (searchBox.classList.contains('active')) {
                        ...
                        searchInput.value = '';
                        searchInput.blur(); // ΛΥΣΗ: Αφαιρεί το focus και εξαναγκάζει το πληκτρολόγιο να κλείσει
