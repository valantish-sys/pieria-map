  ...
  (async function initNewsTicker() {
    ...
    try {
     ...
     /* ========================================================
      ...
      // ΣΩΣΤΟ ΚΟΜΜΑΤΙ: Το εμφανίζουμε εγγυημένα χωρίς να περιμένουμε γραμματοσειρές
      setTimeout(() => {
        requestAnimationFrame(() => {
          calculateAnimation();
          if (tickerOuter) tickerOuter.classList.add("ticker-loaded"); // ΑΥΤΟ ΤΟ ΚΑΝΕΙ ΟΡΑΤΟ
        });
      }, 200);

      // Απλό Resize για τα κινητά
